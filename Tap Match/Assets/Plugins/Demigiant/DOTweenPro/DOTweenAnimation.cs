...
namespace DG.Tweening
{
    ...
    public class DOTweenAnimation : ABSAnimationComponent
    {
        ...
        // [JOM] add Auto-stop so when the object is disabled in the hierarchy, the animation wont be played
        // again and again in the background.
        void OnDisable () {
            if (autoPlay) {
                DOPause();
            }
        ...
        // [JOM] add Auto-stop. The animations need to be resumed when the object is enabled.
        void OnEnable (){
            if (autoPlay) {
                DOPlay();
            }
