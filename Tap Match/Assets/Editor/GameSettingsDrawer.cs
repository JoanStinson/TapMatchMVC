...
namespace JGM.GameEditor
{
    ...
    public class GameSettingsDrawer : Editor
    {
        ...
        private SerializedProperty m_cellColors;
        ...
        private void OnEnable()
        {
            ...
            m_cellColors = serializedObject.FindProperty("m_cellColors");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_cellColors, true);
            int arraySize = m_cellColors.arraySize;
            arraySize = Mathf.Clamp(arraySize, m_minColorsSize, m_maxColorsSize);
            m_cellColors.arraySize = arraySize;
